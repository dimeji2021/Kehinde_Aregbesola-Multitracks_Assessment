<%@ Page Language="C#" AutoEventWireup="true" CodeFile="songDetails.aspx.cs" Inherits="PageToSync_songDetails" %>
                ...
                <div class="wrapper mod-standard mod-gray">
                    ...
                    <nav class="discovery--nav">
                        <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                            ...
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "albumDetails.aspx?id="+Eval("artistID")%>">Albums</a>
                            </li>
                        </ul>
                    </nav>
