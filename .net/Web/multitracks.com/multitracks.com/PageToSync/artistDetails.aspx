...
<p runat="server" id="errorMessage">
    <strong>We are experiencing a lot of traffic presently, please try again later.</strong>
</p>
<body class="premium standard u-fix-fancybox-iframe" runat="server" id="items">
    <asp:Repeater ID="rptArtistDetails" runat="server" OnItemDataBound="rptArtist_ItemDataBound">
        <ItemTemplate>
            <form>
                <script>
                        ...
                        <div class="details-banner--info">
                            <a href="#" class="details-banner--info--box">
                                <img class="details-banner--info--box--img"
                                    src="<%# Eval("artistImage") %>"
                                    srcset="<%# Eval("artistImage") %>,
								 			<%# Eval("artistImage") %>"
                                    alt="<%# Eval("artistTitle") %>">
                            </a>
                    ...
                    <nav class="discovery--nav">
                        <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                            ...
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "../PageToSync/songDetails.aspx?id="+Eval("artistID")%>">Songs</a>
                            </li>
                            <li class="discovery--nav--list--item tab-filter--item">
                                <a class="tab-filter" href="<%# "../PageToSync/albumDetails.aspx?id="+Eval("artistID")%>">Albums</a>
                            </li>
                        </ul>
                        ...
                        <main class="discovery--section">
                            ...
                            <section class="standard--holder">
                                <div class="discovery--section--header">
                                    <h2>Top Songs</h2>
                                    <a class="discovery--section--header--view-all" href="<%# "../PageToSync/songDetails.aspx?id="+Eval("artistID")%>">View All</a>
                                </div>
                                <!-- /.discovery-select -->
                            ...
                            <div class="discovery--space-saver">
                                <section class="standard--holder">
                                    <div class="discovery--section--header">
                                        <h2>Albums</h2>
                                        <a class="discovery--section--header--view-all" href="<%# "../PageToSync/albumDetails.aspx?id="+Eval("artistID")%>">View All</a>
                                    </div>
                                    <!-- /.discovery-select -->
                            ...
                            <section class="standard--holder">
                                ...
                                <div class="artist-details--biography biography">
                                    ...
                                    <a href="#" class="toggle-bio-link">Read More...</a>
                                </div>
                            </section>
